...
COMMON_DEPEND="${PYTHON_DEPS}
	...
	dev-libs/libxml2:2
	gnome-base/librsvg
	>=gnome-extra/cinnamon-desktop-4.6:0=[introspection]
	>=gnome-extra/cinnamon-menus-4.6
	>=gnome-extra/cjs-4.6.0[cairo]
	...
	>=x11-wm/muffin-4.6.0[introspection]
...
RDEPEND="${COMMON_DEPEND}
	...
	x11-misc/xdg-utils
	>=x11-libs/xapp-1.8.9[introspection]
	...
	>=dev-python/xapp-2.0[${PYTHON_USEDEP}]

	x11-themes/gnome-themes-standard
	x11-themes/adwaita-icon-theme

	>=gnome-extra/nemo-4.6
	>=gnome-extra/cinnamon-control-center-4.6
